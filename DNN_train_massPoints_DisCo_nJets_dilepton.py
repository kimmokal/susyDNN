...
for mass_point in mass_point_list:
	...
	for epoch in range(numberOfEpochs):
		...
		plot_losses(epoch, losses, lam, numberOfEpochs, 'Losses_DisCo_dilepton_lambda_'+str(lam))
		tf.keras.backend.clear_session()
	...
	save_name = 'susyDNN_DisCo_dilepton_nJets_lambda'+str(lam)+'_'+str(mass_point)
